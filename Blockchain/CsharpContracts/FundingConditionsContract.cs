namespace BlockiFinAid.Services.SmartContracts.FundingConditions;
...
public class FundingConditionsContract
{
    ...
    public FundingConditionsContract(IOptions<EthereumNodeSettings> nodeSettings, IOptions<SmartContractAddressSettings> addressSettings)
    {
    ...
    public async Task<string> AddConditionAsync(FundingConditionInputDto dto)
    {
    ...
    public async Task<string> UpdateConditionAsync(FundingConditionUpdateDto dto)
    {
    ...
    public async Task<FundingConditionOutputDto> GetConditionByIdAsync(Guid id)
    {
        ...
        var contract = _web3.Eth.GetContractHandler(_addressSettings.FundingConditionsContractAddress);
        var result = await contract.QueryDeserializingToObjectAsync<GetConditionByIdFunction, GetConditionByIdOutputDto>(function);
